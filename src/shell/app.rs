...
use super::{StiffShell, theme::install_stiff_theme};
use crate::features::{clipboard::ClipboardState, file_browser::StiffAssets, layout::LayoutState};

pub fn run(start_path: Option<PathBuf>) {
    Application::new()
        .with_assets(StiffAssets)
        .run(move |app: &mut App| {
            ...
            app.open_window(
                WindowOptions {
                    ...
                    app_id: Some("com.stiff.gpui".to_string()),
